...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="../common/bower_components/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <script src="../common/bower_components/flot/jquery.flot.time.js"></script>
    <script src="../common/bower_components/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="../common/js/flot-data.js"></script>
